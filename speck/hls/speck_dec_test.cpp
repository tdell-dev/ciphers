...
int main()
{
    ...
    speck32s64_decrypt( gold_cyphertxt1, gold_cyphertxt0, gold_key, &test_plaintxt1, &test_plaintxt0);
   
    if (gold_plaintxt1 != test_plaintxt1 || gold_plaintxt0 != test_plaintxt0) {
        fprintf(stdout, "*******************************************\n");
        fprintf(stdout, "FAIL: Output DOES NOT match the golden output\n");
        fprintf(stdout, "Test Pt: %04x, %04x\n", test_plaintxt1, test_plaintxt0);
        fprintf(stdout, "Gold Pt: %04x, %04x\n", gold_plaintxt1, gold_plaintxt0);
        fprintf(stdout, "*******************************************\n");
        return 1;
    } else {
        fprintf(stdout, "*******************************************\n");
    ...
    speck128s256_decrypt( gold_cyphertxt1_64, gold_cyphertxt0_64, gold_key_64, &test_plaintxt1_64, &test_plaintxt0_64);
   
    if (gold_plaintxt1_64 != test_plaintxt1_64 || gold_plaintxt0_64 != test_plaintxt0_64) {
        fprintf(stdout, "*******************************************\n");
        fprintf(stdout, "FAIL: Output DOES NOT match the golden output\n");
        fprintf(stdout, "Test Pt: %04x, %04x\n", test_plaintxt1_64, test_plaintxt0_64);
        fprintf(stdout, "Gold Pt: %04x, %04x\n", gold_plaintxt1_64, gold_plaintxt0_64);
        fprintf(stdout, "*******************************************\n");
        return 1;
    } else {
        fprintf(stdout, "*******************************************\n");
